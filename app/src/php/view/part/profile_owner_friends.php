...
<div class='site-width'>
    <div id="bio" class="contacts-page">
        ...
        <div id="contact-menu-hide-scrollbar">
            <div id="contact-menu">
                <div id="contact-menu-container">
                    <a href="<?php echo "$profileLink&view=friends"; ?>" class="active">
        ...
        <div class="p-container">
            <div class="p-h2">Arkadaşlar</div>
            <div class="p-p3w">Arkadaşlık, mesajlaşma gibi ek özellikler sağlar. Arkadaş olmak için bir takipçini takip et.</div>
        </div>
        ...
        <div id="profile-contacts" class="p-container">
            ...
            <div id="no-contacts" class="cl-message toggle-off">
                <div class="p-h3">Henüz arkadaşın yok</div>
                <div class="p-p3 link-m-color">Lorem ipsum dolor sit amet.</div>
            </div>
