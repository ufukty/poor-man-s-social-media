...
<div class='site-width'>
    <div id="bio" class="contacts-page">
        ...
        <div id="contact-menu-hide-scrollbar">
            <div id="contact-menu">
                <div id="contact-menu-container">
                    ...
                    <a href="<?php echo "$profileLink&view=followers"; ?>" class="active">
                        <i class="fa fa-user-plus"></i>
                        <div>Takipçiler</div>
                    </a>
        ...
        <div class="p-container">
            <div class="p-h2">Takipçiler</div>
            <div class="p-p3w">Takipçilerin, paylaşımlarını görebilir ve beğenebilir.</div>
        </div>
        ...
        <div id="profile-contacts" class="p-container">
            ...
            <div id="no-contacts" class="cl-message toggle-off">
                <div class="p-h3">Henüz seni takip eden biri yok</div>
