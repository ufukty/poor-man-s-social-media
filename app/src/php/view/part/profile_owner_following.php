...
<div class='site-width'>
    <div id="bio" class="contacts-page">
        ...
        <div id="contact-menu-hide-scrollbar">
            <div id="contact-menu">
                <div id="contact-menu-container">
                    ...
                    <a href="<?php echo "$profileLink&view=following"; ?>" class="active">
        ...
        <div class="p-container">
            <div class="p-h2">Takip edilenler</div>
            <div class="p-p3w">Takip ettiğin kullanıcıların gönderilerini görebilir ve beğenebilirsin.</div>
        </div>
        ...
        <div id="profile-contacts" class="p-container">
            ...
            <div id="no-contacts" class="cl-message toggle-off">
                <div class="p-h3">Henüz takip ettiğin biri yok</div>
                <div class="p-p3">Lorem ipsum dolor sit amet.</div>
            </div>
