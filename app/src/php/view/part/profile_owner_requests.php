...
<div class='site-width'>
    <div id="bio" class="contacts-page">
        ...
        <div id="contact-menu-hide-scrollbar">
            <div id="contact-menu">
                <div id="contact-menu-container">
                    ...
                    <a href="<?php echo "$profileLink&view=requests"; ?>" class="active">
        ...
        <div class="p-container">
            <div class="p-h2">İstekler</div>
            <div class="p-p3w">Onlara takip izni verdiğinde senin gönderilerini görebilecekler.</div>
        </div>
        ...
        <div id="profile-contacts" class="p-container">
            ...
            <div id="no-contacts" class="cl-message toggle-off">
                <div class="p-h3">Henüz iznini bekleyen bir istek yok</div>
